...
class SubsectionGradeFactory(object):
    ...
    def _get_saved_grade(self, subsection, course_structure, course):  # pylint: disable=unused-argument
        ...
        if PersistentGradesEnabledFlag.feature_enabled(course.id):
            try:
                ...
                log.warning(
                    u"Persistent Grades: Loaded grade for course with id {0}, version {1}, subtree edited on {2},"
                ...
                log.warning(
                    u"Persistent Grades: Could not find grade for course with id {0}, version {1}, subtree edited"
    ...
    def _save_grade(self, subsection_grade, subsection, course):  # pylint: disable=unused-argument
        ...
        log.warning(u"Persistent Grades: Saved grade for course {0}, version {1}, subtree_edited_on {2}, grade: {3}, "
                    u"user {4}"
                    .format(
                        course.id,
                        getattr(course, 'course_version', None),
