...
class CourseGrade(object):
    ...
    def subsection_grade_totals_by_format(self):
        ...
        log.info(u"Persistent Grades: Calculated subsections_by_format property for {0}, student {1}".format(
    ...
    def locations_to_weighted_scores(self):
        ...
        log.info(u"Persistent Grades: Calculated locations_to_weighted_scores property for {0}, student {1}".format(
            self.course.location,
            self.student.id
        ))
    ...
    def grade_value(self):
        ...
        log.info(u"Persistent Grades: Calculated grade_value property for {0}, student {1}".format(
            self.course.location,
            self.student.id
        ))
        return grade_value
